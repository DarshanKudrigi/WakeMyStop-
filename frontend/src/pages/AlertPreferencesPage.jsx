...
function AlertPreferencesPage() {
  ...
  return (
    <div className="w-full max-w-2xl mx-auto space-y-5 pb-24 px-3 sm:px-4 pt-2">
      ...
      <div className="bg-white dark:bg-[#161c26] rounded-3xl border border-slate-200/80 dark:border-slate-800/80 p-5 shadow-sm space-y-4">
      ...
      <div className="bg-white dark:bg-[#161c26] rounded-3xl border border-slate-200/80 dark:border-slate-800/80 p-5 shadow-sm space-y-4">
        <div className="space-y-1.5">
          ...
          <select
            ...
            className="w-full p-3 rounded-2xl bg-slate-50 dark:bg-slate-800/60 border border-slate-200 dark:border-slate-700 font-extrabold text-slate-900 dark:text-white text-xs focus:outline-none cursor-pointer"
          >
          ...
          <div className="w-full max-w-md bg-white dark:bg-[#161c26] rounded-3xl border border-slate-200 dark:border-slate-800 p-6 sm:p-7 shadow-2xl space-y-5 text-center animate-in fade-in zoom-in-95 duration-150">
            ...
            <div className="space-y-2">
              ...
              <p className="text-xs font-semibold text-slate-600 dark:text-slate-300 leading-relaxed">
                RailAlert AI is now monitoring your journey. You will receive alerts before your destination. Enjoy your journey!
              </p>
            </div>
            ...
            <div className="pt-2">
              <button
                ...
                className="w-full py-3.5 px-6 rounded-2xl bg-gradient-to-r from-blue-600 via-blue-500 to-indigo-600 hover:from-blue-500 hover:to-indigo-500 text-white font-black text-xs shadow-lg shadow-blue-500/20 active:scale-[0.98] transition-all cursor-pointer"
              >
                Go to Dashboard
              </button>
            </div>
