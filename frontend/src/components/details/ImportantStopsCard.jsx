              ...
              <div key={`${stop.code}-${idx}`}>
                ...
                <div
                  ...
                  className={`relative grid grid-cols-12 items-center py-3.5 px-2 transition-colors ${
                    isCurrent && isStoppedAtStation ? 'scroll-mt-28 bg-blue-50/40 dark:bg-blue-950/20 rounded-2xl border border-blue-200/60 dark:border-blue-800/40' : ''
                  }`}
                >
                  ...
                  <div className="col-span-6 flex items-center gap-2 relative z-10 pl-2 sm:pl-3">
                    ...
                    <div className="relative shrink-0 flex items-center justify-center">
                      {showTrainLogoAtNode ? (
                        /* Blue Train Logo Badge when stopped at station */
                        ...
                        /* Orange Station Code Badge (Always displayed on station rows) */
                    ...
                    <div className="min-w-0">
                      <h3 className={`text-xs sm:text-sm font-black uppercase tracking-tight truncate ${
                        isCurrent && isStoppedAtStation ? 'text-blue-600 dark:text-blue-400 font-extrabold' : 'text-slate-900 dark:text-white'
                      }`}>
                        {stop.name}
                      </h3>
                ...
                {isCurrent && !isStoppedAtStation && idx < stops.length - 1 && (
                  <div className="relative grid grid-cols-12 items-center py-2 px-2">
                    ...
                    {/* Blue Circular Train Badge sitting directly ON the track line */}
                    <div className="col-span-6 flex items-center pl-2 sm:pl-3 relative z-10">
                      <div className="w-7 h-7 rounded-full bg-blue-600 text-white flex items-center justify-center shadow-md border-2 border-white dark:border-[#111936] shrink-0">
                        <Train className="w-4 h-4 text-white" />
                      </div>
                    </div>
